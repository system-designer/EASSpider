...
public class LoginConstants {
    ...
    public static final String user = "897929321@qq.com";//教务系统管理员的账号和密码
    public static final String password = "897929321@qq.com";
    //登录地址
    ...
    //查询学生信息的地址
    public static String searchUrl = "http://www.jwgl.hbnu.edu.cn/{0}/xsxx.aspx?xh=" + user + "&xm=&gnmkdm=N120306";
    public static String contentRef = "http://www.jwgl.hbnu.edu.cn/{0}/bm_main.aspx?xh=" + user;
    //学生照片地址
    ...
    //查询课表地址
    public static String timeTableUrl="http://www.jwgl.hbnu.edu.cn/{0}/tjkbcx.aspx?xh="+user+"&xm=&gnmkdm=N120310";
